<template>
  ...
  >
    ...
    <div class="navbar__bottom">
      <router-link class="navbar__link" :to="{ name: 'projects', params: {} }"
        >Projects</router-link
      >
      <router-link class="navbar__link" :to="{ name: 'lab', params: {} }"
        >Lab</router-link
      >
      <router-link class="navbar__link" :to="{ name: 'components', params: {} }"
        >Components</router-link
      >
      <router-link class="navbar__link" :to="{ name: 'about', params: {} }"
        >About</router-link
      >
    </div>
  </section>
...
export default {
  ...
  mounted() {
    window.innerWidth > 700 ? (this.isMobile = false) : (this.isMobile = true);
  }
};
</script>
